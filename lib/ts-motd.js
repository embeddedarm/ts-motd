...
var TsMotd = function () {
	...
	console.log("New socket connection!  Creating a new fabric canvas.");
	    ...
	    console.log("Application already loaded.  Reloading.");
            location.reload();
        }
        else {
	    console.log("Application not loaded.  Loading initial state from JSON and rendering all.");
...
window.app = {
    ...
    init: function() {
        var _this = this;
        console.info("Init ts-motd whiteboard");
